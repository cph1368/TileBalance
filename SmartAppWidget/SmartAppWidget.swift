...
struct Provider: TimelineProvider {
    ...
    func getTimeline(in context: Context, completion: @escaping (Timeline<Entry>) -> ()) {
        ...
        for hourOffset in 0 ..< 5 {
            ...
            let entry = SimpleEntry(date: entryDate, widgetcontents: MyDataProvider.getwidgetcontent())
...
struct SmartAppWidget_Previews: PreviewProvider {
    static var previews: some View {
        SmartAppWidgetEntryView(entry: SimpleEntry(date: Date(), widgetcontents: "My Widget Content"))
